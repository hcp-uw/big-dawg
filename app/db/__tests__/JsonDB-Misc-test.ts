import { Exercise, Exercise_List, Set, Workout } from '../Types'
...
describe('json_db Misc/Rest Tests', () => {
    ...
    it('getCalendarView_simpleOneDay', async () => {
        ...
        await expect(db.getCalendarView(new Date(2025, 3))).resolves.toStrictEqual(muscleGroups)
    })
    ...
    it('getCalendarView_noDateRecord', async () => {
        ...
        await expect(db.getCalendarView(new Date(2025, 10))).resolves.toStrictEqual([])
    })
})
